...
公開データは[廣瀬本萬葉集ビューワ](https://tei.pages.nijl.ac.jp/manyoshuteiviewer/)でご覧いただけます。ビューワでは、廣瀬本万葉集の本文テキストおよび書き入れ情報を表示するとともに、関西大学デジタルアーカイブが公開するIIIF画像と連携して資料画像を参照することができます。また、題詞・歌・訓・書き入れの一覧表示、本文の全文検索、誤記・漢字表記の切り替えなど、インタラクティブな閲覧・検索機能を備えています。
